...
export default function ContactFAQ({ faqs = [] }: Props) {
  ...
  return (
    <section className="w-full bg-white px-5 py-20 sm:px-8 sm:py-24 lg:px-12 lg:py-28">
        ...
        <div className="grid min-w-0 gap-12 lg:grid-cols-[minmax(0,0.6fr)_minmax(0,1.4fr)] lg:gap-20">
          ...
          >
            <div className="flex items-center gap-3">
              <span className="h-px w-9 shrink-0 bg-[#087E8B]" />

              <span className="min-w-0 text-[10px] font-semibold uppercase tracking-[0.22em] text-[#071A33]/40">
                Before you write
              </span>
            </div>
            ...
            <p className="mt-5 max-w-sm text-sm leading-7 text-[#071A33]/50">
              Still have a question? Our full FAQ section has more answers
              about planning your journey.
            </p>
